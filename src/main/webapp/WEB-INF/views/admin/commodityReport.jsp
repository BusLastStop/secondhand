					    ...
					    <table style="width: 100%; border-collapse: collapse; text-align: center; background-color: #fff; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1); border-radius: 8px; overflow: hidden;">
					        <thead style="background-color: #ff8a65; color: #fff;">
					            <tr>
					                ...
					                <th style="border: 1px solid #ddd; padding: 12px; font-size: 16px;">제목</th>
					                <th style="border: 1px solid #ddd; padding: 12px; font-size: 16px;">내용</th>
					                <th style="border: 1px solid #ddd; padding: 12px; font-size: 16px;">작성자</th>
					                <th style="border: 1px solid #ddd; padding: 12px; font-size: 16px;">댓글수</th>
					        ...
					        <tbody>
					            ...
					            <c:forEach var="reportList" items="${reportList}">
						            <tr style="background-color: #f9f9f9; transition: background-color 0.3s;">
						                ...
						                <td style="border: 1px solid #ddd; padding: 12px; font-size: 14px;" id="reportView">${reportList.boaTitle}</td>
						                <td style="border: 1px solid #ddd; padding: 12px; font-size: 14px;">${reportList.boaContent}</td>
						                <td style="border: 1px solid #ddd; padding: 12px; font-size: 14px;">${reportList.memName}</td>
						                <td style="border: 1px solid #ddd; padding: 12px; font-size: 14px;">${reportList.boaViews}</td>
						                ...
						                <td style="border: 1px solid #ddd; padding: 12px; font-size: 14px;">
						                    <button style="border: 1px solid #ff8a65; background-color: #ffccbd; border-radius: 8px; padding: 6px 12px; cursor: pointer;">삭제</button>
						                </td>
						            </tr>
					            </c:forEach>
					        </tbody>
...
<script>
	$("#reportView").click(e=>{
		location.assign("${path}/commodity/report/board/view.do?boaCode=${reportList.boaCode}");
	});
</script>
